                            ...
                            <TableRow key={tx.id}>
                                ...
                                <TableCell>
                                    ...
                                    {['successful', 'completed', 'paid'].includes(tx.payment_status) ? (
                                        <span className="rounded-full px-3 py-1 text-sm font-medium bg-green-200/90 text-green-900">
                                            {tx.payment_status}
                                        </span>
                                    ) : ['failed', 'cancelled'].includes(tx.payment_status) ? (
                                        <span className="rounded-full px-3 py-1 text-sm font-medium bg-red-200/90 text-red-900">
                                            {tx.payment_status}
                                        </span>
                                    ) : (
                                        <span className="rounded-full px-3 py-1 text-sm font-medium bg-yellow-200/90 text-yellow-900">
                                            {tx.payment_status}
                                        </span>
                                    )}
                                </TableCell>
                                <TableCell>
                                    ...
                                    {tx.transaction_type === 'credit' ? (
                                        ...
                                        <span className="rounded-full px-3 py-1 text-sm font-medium bg-gray-200/90  text-gray-900">
                                            {tx.transaction_type}
                                        </span>
                                    )}
                                </TableCell>
