...
function ChargesTab() {
  ...
  const EMPTY_FORM: FormFields = {
    payment_gateway_fee: "",
    value_added_tax: "",
    payout_charge_upto_5000: "",
    payout_charge_5001_to_50000: "",
    payout_charge_above_50000: "",
    stamp_duty: "",
    base_delivery_fee: "",
    delivery_fee_per_km: "",
    delivery_commission_percentage: "",
    food_commission_percentage: "",
    laundry_commission_percentage: "",
    product_commission_percentage: "",
    delivery_commission_rate: "",
    food_commission_rate: "",
    laundry_commission_rate: "",
  ...
  const saveMutation = useMutation({
    ...
    onError: () =>
      setError(
        "Failed to save charges. Make sure you have SUPER_ADMIN access.",
      ),
  });
  ...
  return (
    <div className="space-y-6">
      ...
      {success && (
        <p className="text-sm text-green-600 bg-green-500/10 px-3 py-2 rounded">
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <ChargesField
            ...
            onChange={setField("payment_gateway_fee")}
            hint="Charged per transaction"
          />
          <ChargesField
            label="Value Added Tax (VAT)"
            value={form.value_added_tax}
            onChange={setField("value_added_tax")}
          />
          <ChargesField
            label="Stamp Duty"
            value={form.stamp_duty}
            onChange={setField("stamp_duty")}
          />
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <ChargesField
            label="Up to ₦5,000"
            value={form.payout_charge_upto_5000}
            onChange={setField("payout_charge_upto_5000")}
          />
          <ChargesField
            label="₦5,001 – ₦50,000"
            value={form.payout_charge_5001_to_50000}
            onChange={setField("payout_charge_5001_to_50000")}
          />
          <ChargesField
            label="Above ₦50,000"
            value={form.payout_charge_above_50000}
            onChange={setField("payout_charge_above_50000")}
          />
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Base fee and per-km rate for delivery orders
          </CardDescription>
        </CardHeader>
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1.5">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              onChange={(e) => setField("delivery_fee_per_km")(e.target.value)}
            />
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Platform commission per service type
          </CardDescription>
        </CardHeader>
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <ChargesField
            label="Delivery Commission %"
            value={form.delivery_commission_percentage}
            onChange={setField("delivery_commission_percentage")}
          />
          <ChargesField
            label="Food Commission %"
            value={form.food_commission_percentage}
            onChange={setField("food_commission_percentage")}
          />
          <ChargesField
            label="Laundry Commission %"
            value={form.laundry_commission_percentage}
            onChange={setField("laundry_commission_percentage")}
          />
          <ChargesField
            label="Product Commission %"
            value={form.product_commission_percentage}
            onChange={setField("product_commission_percentage")}
          />
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Fixed rate commissions per service type
          </CardDescription>
        </CardHeader>
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <ChargesField
            ...
            onChange={setField("delivery_commission_rate")}
          />
          <ChargesField
            label="Food Commission Rate"
            value={form.food_commission_rate}
            onChange={setField("food_commission_rate")}
          />
          <ChargesField
            label="Laundry Commission Rate"
            value={form.laundry_commission_rate}
            onChange={setField("laundry_commission_rate")}
          />
          <ChargesField
            label="Product Commission Rate"
            value={form.product_commission_rate}
            onChange={setField("product_commission_rate")}
          />
        </CardContent>
      </Card>
