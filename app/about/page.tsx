      ...
      <Card className="text-card-foreground px-2 shadow-none border-none">
        ...
        <CardContent className="max-w-4xl mx-auto space-y-12">
          ...
          <section className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              MohStack specializes in building cutting-edge mobile and web
              applications that solve real-world problems. With expertise in
              custom software development, our team combines technical
              excellence with deep market understanding to create platforms that
              truly serve African communities. Our commitment to quality,
              security, and user experience drives everything we build.
            </p>

            <p className="text-muted-foreground leading-relaxed">
              From enterprise solutions to consumer-facing apps, MohStack is
              positioning itself as a trusted technology partner, delivering
              scalable, reliable, and innovative software products. ServiPal,
              our flagship mobile app, represents our vision of leveraging
              technology to connect people, empower businesses, and simplify
              everyday life across Nigeria.
            </p>
          </section>
          ...
          <section className="bg-primary/5 p-6 rounded-lg border space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              We exist to simplify daily life for customers while empowering
              local businesses to grow. By connecting verified vendors with
              thousands of active users across Nigeria, we're building a
              thriving ecosystem where convenience meets opportunity.
            </p>
          </section>
          ...
          <section className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ServiPal operates as an all-in-one marketplace where customers can
              access multiple essential services while vendors can reach a wider
              audience and grow their revenue. Our platform serves two key
              audiences:
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-6">
              <div className="p-6 rounded-lg border bg-card">
                ...
                <p className="text-muted-foreground text-sm">
                  Browse hundreds of trusted vendors offering meals, laundry
                  services, delivery options, and products—all verified and
                  reviewed for your peace of mind. Enjoy secure payments, and
                  the convenience of managing all your lifestyle needs in one
                  place.
                </p>
              </div>
              ...
              <div className="p-6 rounded-lg border bg-card">
                ...
                <p className="text-muted-foreground text-sm">
                  Expand your business reach, manage orders efficiently, and
                  receive secure payments through our escrow-protected system.
                  Whether you're a restaurant owner, dispatch rider, laundry
                  service provider, or online seller, ServiPal gives you the
                  tools and customer base to succeed.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              With ServiPal, vendors focus on delivering great service while we
              handle the technology, payments, and customer connections.
            </p>
          ...
          <section className="bg-primary/10 p-8 rounded-lg border-2 border-primary/20 text-center space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Whether you're looking for convenient access to everyday services
              or seeking to grow your business, ServiPal is your partner for
              success. Download the app today and experience the future of
              lifestyle services in Nigeria.
            </p>
