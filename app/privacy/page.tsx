          ...
          <main className="col-span-12 md:col-span-9">
            ...
            <section id="interpretation" className="mb-8 pt-16 -mt-16">
              ...
              <ul className="space-y-4">
                ...
                <ListItem>
                  <p>
                    <strong>Application</strong> refers to ServiPal, the
                ...
                <ListItem>
                  <p>
                    <strong>Website</strong> refers to ServiPal, accessible from{" "}
                    <a
            ...
            <section id="collecting" className="mb-8 pt-16 -mt-16">
              ...
              <ul className="space-y-4">
                ...
                <ListItem>
                  <p>Company or Business registration number</p>
                </ListItem>
                <ListItem>
                  <p>Address, State, City</p>
                </ListItem>
                <ListItem>
                  <p>Usage Data</p>
                </ListItem>
